...
if [ -e ./c_aaseri_ERR10466724_collected_reads.ovlStore.BUILDING/bucket$jobname ] ; then
  echo "Bucketizing job finished; directory './c_aaseri_ERR10466724_collected_reads.ovlStore.BUILDING/bucket$jobname' exists."
  exit
fi
